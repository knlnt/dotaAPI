...
var server_ = __webpack_require__("2+G7");
...
class _document_MyDocument extends document_default.a {
  static async getInitialProps(ctx) {
    ...
    try {
      ctx.renderPage = () => originalRenderPage({
        enhanceApp: App => props => _objectSpread({}, sheet.collectStyles(external_react_default.a.createElement(App, props)), sheets.collect(external_react_default.a.createElement(App, props)))
      });

      const initialProps = await document_default.a.getInitialProps(ctx);
      return _objectSpread({}, initialProps, {
        styles: external_react_default.a.createElement(external_react_default.a.Fragment, null, sheets.getStyleElement(), sheet.getStyleElement(), server_default()() || null)
      });
    } finally {
      sheet.seal();
    }
  ...
  render() {
    ...
    }), external_react_default.a.createElement("title", null, "My page"), this.props.styleTags, external_react_default.a.createElement("link", {
      rel: "stylesheet",
